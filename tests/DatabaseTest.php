...
class DatabaseTest extends TestCase
{
    ...
    public function test_table_created_successfully()
    {
        ...
        $this->assertSessionHasAll($this->alertSuccess(__('logoinc::database.success_create_table', ['table' => $this->table['name']])));
        $this->assertRedirectedToRoute('logoinc.database.index');
    ...
    public function test_can_drop_table()
    {
        ...
        $this->delete(route('logoinc.database.destroy', $this->table['name']));

        // Test correct response
        $this->assertSessionHasAll($this->alertSuccess(__('logoinc::database.success_delete_table', ['table' => $this->table['name']])));
        $this->assertRedirectedToRoute('logoinc.database.index');
    ...
    protected function update_table_that_not_exist()
    {
        ...
        $this->put(route('logoinc.database.update', $table['oldName']), [
    ...
    protected function update_table(array $table)
    {
        ...
        // Test correct response
        $this->assertSessionHasAll($this->alertSuccess(__('logoinc::database.success_create_table', ['table' => $table['name']])));
        $this->assertRedirectedToRoute('logoinc.database.index');
