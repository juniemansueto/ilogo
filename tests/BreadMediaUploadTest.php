...
class BreadMediaUploadTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->storage = Storage::disk(config('logoinc.storage.disk'));
    }
    ...
    public function testMultipleImagesDelete()
    {
        ...
        $response = $this->post(route('logoinc.pages.media.remove'), [
            'id'        => $page->id,
            'slug'      => 'pages',
            'field'     => 'image',
            'multi'     => 'true',
    ...
    public function testFileDelete()
    {
        ...
        $this->call('POST', route('logoinc.pages.media.remove'), [
            'id'        => $page->id,
            'slug'      => 'pages',
            'field'     => 'image',
            'multi'     => 'true',
    ...
    public function testUploadSecondFile()
    {
        ...
        $this->call('PUT', route('logoinc.pages.update', $page->id), [
