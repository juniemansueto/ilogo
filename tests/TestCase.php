...
class TestCase extends OrchestraTestCase
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        // Setup Logoinc configuration
        $app['config']->set('logoinc.user.namespace', User::class);
    ...
    {
        $this->artisan('logoinc:install', ['--with-dummy' => $this->withDummy]);

        app(LogoincServiceProvider::class, ['app' => $this->app])->loadAuth();
