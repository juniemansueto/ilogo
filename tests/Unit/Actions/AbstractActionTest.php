...
namespace ILOGO\Logoinc\Tests\Unit\Actions;
...
class AbstractActionTest extends TestCase
{
     ...
     *
     * @var \ILOGO\Logoinc\Models\DataType
     */
    ...
    public function setUp(): void
    {
        ...
        $this->userDataType = Logoinc::model('DataType')->where('name', 'users')->first();
