...
trait LogoincUser
{
    ...
    {
        return $this->belongsTo(Logoinc::modelClass('Role'));
    }
    ...
    {
        return $this->belongsToMany(Logoinc::modelClass('Role'), 'user_roles', 'user_id', 'role_id');
    }
    ...
    {
        $role = Logoinc::model('Role')->where('name', '=', $name)->first();
