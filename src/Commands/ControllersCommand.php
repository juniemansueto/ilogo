...
class ControllersCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'logoinc:controllers';
     ...
     * @var string
     */
    protected $description = 'Publish all the controllers from Logoinc.';
    ...
    {
        $stub = $this->getStub();
        $files = $this->filesystem->files(base_path('vendor/ilogo/logoinc/src/Http/Controllers'));
        $namespace = config('logoinc.controllers.namespace', 'ILOGO\\Logoinc\\Http\\Controllers');
        ...
        $this->info('Published Logoinc controllers!');
    }
    ...
    {
        return $this->filesystem->get(base_path('/vendor/ilogo/logoinc/stubs/'.$this->stub));
    }
    ...
    protected function generateContent($stub, $class)
    {
        ...
        $content = str_replace(
            'FullBaseDummyClass',
            'ILOGO\\Logoinc\\Http\\Controllers\\'.$class,
            $content
        );
