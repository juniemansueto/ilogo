...
class PagesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if (!$dataType->exists) {
            $dataType->fill([
                'name'                  => 'pages',
                'display_name_singular' => __('logoinc::seeders.data_types.page.singular'),
                'display_name_plural'   => __('logoinc::seeders.data_types.page.plural'),
                'icon'                  => 'logoinc-file-text',
                'model_name'            => 'ILOGO\\Logoinc\\Models\\Page',
                'controller'            => '',
        ...
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'image',
                'display_name' => __('logoinc::seeders.data_rows.page_image'),
                'required'     => 0,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 1,
        ...
        $menuItem = MenuItem::firstOrNew([
            'menu_id' => $menu->id,
            'title'   => __('logoinc::seeders.menu_items.pages'),
            'url'     => '',
