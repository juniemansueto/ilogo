...
return [
    'welcome'                => 'Добро пожаловать в Logoinc Compass. Каждое хорошее приложение нуждается в компасе, чтобы указать им в правильном направлении.
     В этом разделе вы найдете много ресурсов и административных задач, которые помогут вам в создании вашего приложения.',
    'links'         => [
        'title'                 => 'Ссылки',
        'documentation'         => 'Документация',
        'logoinc_homepage'      => 'Страница Logoinc',
        'logoinc_hooks'         => 'Хуки Logoinc',
    ],
    'commands'      => [
        'title'                 => 'Команды',
        'text'                  => 'Запустите команду Artisan от Logoinc.',
    ...
    'resources'     => [
        'title'                 => 'Ресурсы',
        'text'                  => 'Ресурсы Logoinc, которые помогут вам найти вещи быстрее.',
    ...
    'fonts'         => [
        'title'                 => 'Шрифты',
        'font_class'            => 'Карта классов шрифта Logoinc',
        'font_character'        => 'Карта символов шрифта Logoinc',
    ],
];
