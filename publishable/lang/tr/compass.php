...
return [
    'welcome'                => 'Logoinc Pusula\'ya hoşgeldiniz. Her iyi uygulama doğru istikamette ilerlemek için bir pusulaya ihtiyaç duyar.
    Bu bölümde uygulamanızı geliştirirken size rehberlik edecek bir çok kaynak ve yönetimsel görev bulacaksınız.',
    'links'         => [
        'title'                 => 'Bağlantılar',
        'documentation'         => 'Dokümantasyon',
        'logoinc_homepage'      => 'Logoinc Anasayfa',
        'logoinc_hooks'         => 'Logoinc Hookları',
    ],
    'commands'      => [
        'title'                 => 'Komutlar',
        'text'                  => 'Artisan Komutlarını Logoinc\'dan Çalıştır.',
    ...
    'resources'     => [
        'title'                 => 'Kaynaklar',
        'text'                  => 'Aradığınız şeyleri bulmanızı kolaylaştıracak Logoinc kaynakları.',
    ...
    'fonts'         => [
        'title'                 => 'İkonlar',
        'font_class'            => 'Logoinc İkon Class Eşleştirmesi',
        'font_character'        => 'Logoinc İkon Karakter Eşleştirmesi',
    ],
];
