...
return [
    'welcome'                => 'Bienvenido(a) a Logoinc Compass. Toda buena aplicación necesita una brújula que guíe en la dirección correcta.
    En esta sección encontrará recursos y tareas administrativas para ayudarle con la construcción de su aplicación.',
    'links'         => [
        'title'                 => 'Enlaces',
        'documentation'         => 'Documentación',
        'logoinc_homepage'      => 'Página de inicio de Logoinc',
        'logoinc_hooks'         => 'Logoinc Hooks',
    ],
    'commands'      => [
        'title'                 => 'Comandos',
        'text'                  => 'Ejecute comandos Artisan desde Logoinc.',
    ...
    'resources'     => [
        'title'                 => 'Recursos',
        'text'                  => 'Recursos sobre Logoinc a la mano.',
    ],
    'logs'          => [
        'title'                 => 'Registros',
    ...
    'fonts'         => [
        'title'                 => 'Fuentes',
        'font_class'            => 'Mapa de clases de Logoinc Fonts',
        'font_character'        => 'Mapa de caracteres de Logoinc Fonts',
    ],
];
