...
return [
    'welcome'           => 'Välkommen till Logoinc Compass. Alla bra appar behöver in kompass som visar riktningen.
    I denna avdelning hittar du resurser som hjälper dig att bygga din applikation',
    'links' => [
        'title'                 => 'Länkar',
        'documentation'         => 'Dokumentation',
        'logoinc_homepage'      => 'Logoinc Hemsida',
        'logoinc_hooks'         => 'Logoinc Hooks',
    ],
    'commands' => [
        'title'                 => 'Kommandon',
        'text'                  => 'Kör Artisan Kommandon från Logoinc.',
    ...
    'resources' => [
        'title'                 => 'Resurser',
        'text'                  => 'Logoinc resurser som hjälper dig hitta snabbare.',
    ],
    'logs' => [
        'title'                 => 'Loggar',
    ...
    'fonts' => [
        'title'                 => 'Typsnitt',
        'font_class'            => 'Logoinc Typsnitt Klasser',
        'font_character'        => 'Logoinc Typsnitt Tecken',
    ],
];
