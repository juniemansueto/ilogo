...
return [
    'welcome'                => 'Բարի գալուստ Logoinc կողմնացույց. Յուրաքանչյուր լավ հավելվածի պետք է կողմնացույց, որը կմատնանշի նրանց ճիշտ ուղղությամբ։
    ...
    'links'         => [
        ...
        'logoinc_homepage'      => 'Logoinc Գլխավոր էջ',
        'logoinc_hooks'         => 'Logoinc Hooks',
    ],
    'commands'      => [
        'title'                 => 'Հրամաններ',
        'text'                  => 'Աշխատեցնել Artisan հրամանները Logoinc-ից։',
    ...
    'resources'     => [
        'title'                 => 'Ռեսուրսներ',
        'text'                  => 'Logoinc-ի ռեսուրսները օգնում են Ձեզ գտնել ավելի արագ',
    ...
    'fonts'         => [
        'title'                 => 'Տառատեսակներ',
        'font_class'            => 'Logoinc-ի տառատեսակների դասերի քարտեզագրում',
        'font_character'        => 'Logoinc-ի տառատեսակների նիշերի քարտեզագրում',
    ],
];
