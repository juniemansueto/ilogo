...
return [
    'welcome'                => 'Добре дошли във Logoinc Compass. Всяка хубава апликация има нужда от компас да насочва потребителите към правилната посока.

    В тази секция ще намерите много ресурси и административки задачи, които ще ви помогнат да създадете вашата апликация.',
    'links'         => [
        'title'                 => 'Линкове',
        'documentation'         => 'Документация',
        'logoinc_homepage'      => 'Начална страница на Logoinc',
        'logoinc_hooks'         => 'Logoinc Hooks',
    ],
    'commands'      => [
        'title'                 => 'Команди',
        'text'                  => 'Run Artisan команди от Logoinc.',
    ...
    'resources'     => [
        'title'                 => 'Ресурси',
        'text'                  => 'Logoinc ресурси, които ще ви помогнат да намерите всичко по-бързо.',
    ...
    'fonts'         => [
        'title'                 => 'Фонтове',
        'font_class'            => 'Logoinc Fonts Class Mapping',
        'font_character'        => 'Logoinc Fonts Character Mapping',
    ],
];
