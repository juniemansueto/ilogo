...
return [
    'welcome'                => 'Bem-vindo à Bússola do Logoinc. Todo bom app precisa de uma bússola para mostrar a direção correta.
    Nessa seção você encontrará muitos recursos e tarefas administativas que o guiará na construção de sua aplicação.',
    'links'         => [
        'title'                 => 'Links',
        'documentation'         => 'Documentação',
        'logoinc_homepage'      => 'Página Inicial do Logoinc',
        'logoinc_hooks'         => 'Logoinc Hooks',
    ],
    'commands'      => [
        'title'                 => 'Comandos',
        'text'                  => 'Rodar Comandos Artisan a partir do Logoinc.',
    ...
    'resources'     => [
        'title'                 => 'Recursos',
        'text'                  => 'Os Recursos Logoinc ajudará você encontrar as coisas mais rápido.',
    ...
    'fonts'         => [
        'title'                 => 'Fontes',
        'font_class'            => 'Mapa de Classe de Fonte Logoinc',
        'font_character'        => 'Mapa de Caracteres de Fonte Logoinc',
    ],
];
