...
return [
    'welcome'                => 'بەخێربێیت بۆ قیبلەنمای ڤۆیەیجەر (Logoinc). هەموو ئەپڵیکەیشنێک پێویستی بە قیبلەنمایەکە بۆ نیشاندانی ڕێی ڕاست.
    ...
    'links'         => [
        ...
        'logoinc_homepage'      => 'پەڕەی سەرەتای ڤۆیەیجەر (Logoinc)',
        'logoinc_hooks'         => 'هووکەکانی ڤۆیەیجەر (Logoinc)',
    ],
    'commands'      => [
        'title'                 => 'ناونیشان',
