...
return [
    'welcome'                => '
    به قطب نمای logoinc خوش آمدید! هر اپلیکیشن خوب باید یک قطب نما داشته باشد که کاربران را به جهات صحیح هدایت کند!.
    ...
    'links'         => [
        ...
        'logoinc_homepage'      => 'صفحه اصلی logoinc',
        'logoinc_hooks'         => 'هوک های logoinc',
    ],
    'commands'      => [
        'title'                 => 'دستورات',
        'text'                  => 'اجرای دستورات Artisan از logoinc',
    ...
    'resources'     => [
        'title'                 => 'منابع',
        'text'                  => 'منابع Logoinc برای کمک به شما جهت یافتن سریع تر آنچه به دنبالش هستید',
    ...
    'fonts'         => [
        'title'                 => 'فونت ها',
        'font_class'            => 'نقشه کلاس های فونت Logoinc',
        'font_character'        => 'نقشه کاراکترهای فونت Logoinc',
    ],
];
