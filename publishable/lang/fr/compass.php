...
return [
    'welcome'                => 'Bienvenue sur Logoinc Compass. Chaque nouvelle application a besoin d\'une boussole pour se diriger dans la bonne direction.
    ...
    'links'         => [
        ...
        'logoinc_homepage'      => 'Logoinc Homepage',
        'logoinc_hooks'         => 'Logoinc Hooks',
    ],
    'commands'      => [
        'title'                 => 'Commandes',
        'text'                  => 'Lancer les Commandes artisan depuis Logoinc.',
    ...
    'resources'     => [
        'title'                 => 'Ressources',
        'text'                  => 'Ressources Logoinc pour vous aider a trouver certaines choses plus vite.',
    ],
    'logs'          => [
        'title'                 => 'Logs',
    ...
    'fonts'         => [
        ...
        'font_class'            => 'Classe de correspondance à la police Logoinc',
        'font_character'        => 'Caractère de correspondance à la police Logoinc',
    ],
];
