...
With Logoinc you can easily create menus for your application. In fact the Logoinc admin is using the menu builder for the navigation you use on the left hand side.
