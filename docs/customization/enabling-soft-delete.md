...
This is only to assist with enabling soft-deletion for your models within Logoinc. Please refer to the [Laravel documentation](https://laravel.com/docs/eloquent#soft-deleting) for specifics.

## Table Configurations in Logoinc
