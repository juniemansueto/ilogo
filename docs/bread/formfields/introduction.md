...
Formfields are the hearth of Logoincs BREAD-system.  
...
All types can include a description in order to help your future self or other users using your Logoinc admin panel to understand exactly what a specific BREAD input field is for, this can be defined in the `Optional Details` JSON input field:
