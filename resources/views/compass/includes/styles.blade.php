<style type="text/css">
        .logoinc .compass .nav-tabs{
            background:none;
            border-bottom:0px;
        }

        .logoinc .compass .nav-tabs > li{
            margin-bottom:-1px !important;
        }

        .logoinc .compass .nav-tabs a{
            text-align: center;
            font-size: 10px;
            font-weight: normal;
            background: #f8f8f8;
        ...
        #gradient_bg{
            ...
            top: 61px;
            left: 0px;
            background-image: url(/vendor/tcg/logoinc/assets/images/bg.jpg);
        ...
        .logoinc .compass .nav-tabs > li > a:hover{
        ...
        .logoinc-link span.resource_label{
            text-align: center;
            color: #fff;
            display: block;
            position: absolute;
        ...
        .logoinc-link span.resource_label:hover{
            opacity:1;
        }
        ...
        .logoinc-link span.resource_label:hover i{
            
            opacity:1;
            transition:all 0.3s linear;
        }

        .logoinc-link span.copy{
            position: absolute;
            font-size: 16px;
            left: 0px;
            bottom: 70px;
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#b3111111', endColorstr='#b3111117',GradientType=1 ); /* IE6-9 fallback on horizontal gradient */
        ...
        .logoinc #logs .table>thead>tr>th:first-child{
            border-top-left-radius: 3px;
        }

        .logoinc #logs .table>thead>tr>th:last-child{
            border-top-right-radius: 3px;
        }
