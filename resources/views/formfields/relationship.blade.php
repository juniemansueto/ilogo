    ...
    @if(class_exists($options->model))
        ...
        @if($options->type == 'belongsTo')
            ...
            @if(isset($view) && ($view == 'browse' || $view == 'read'))
                ...
                @else
                    <p>{{ __('logoinc::generic.no_results') }}</p>
                @endif
            ...
            @else
                ...
                <select
                    ...
                    data-get-items-route="{{route('logoinc.' . $dataType->slug.'.relation')}}"
            ...
            @else
                <select
                    ...
                    @if(isset($options->taggable) && $options->taggable === 'on')
                        data-route="{{ route('logoinc.'.\Illuminate\Support\Str::slug($options->table).'.store') }}"
                        data-label="{{$options->label}}"
                        data-error-message="{{__('logoinc::bread.error_tagging')}}"
                    @endif
                >
